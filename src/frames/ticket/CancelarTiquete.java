 ...
 * @author juanf
 */
public class CancelarTiquete extends javax.swing.JFrame {

    //Constructor
    public CancelarTiquete() {
        initComponents();
        setResizable(false);
        setLocationRelativeTo(null); 
        setTitle("Cancelar Tiquetes");
    }
    ...
    private void initComponents() {
        ...
        jButtonBorrarTiquete = new javax.swing.JButton();
        ...
        jPanelFondo.add(jLabelBuscarTiquete, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 210, -1, -1));

        jLabelTiquete.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabelTiquete.setForeground(new java.awt.Color(255, 255, 255));
        jLabelTiquete.setText("Cancelar Tiquetes");
        ...
        jPanelFondo.add(jButtonBuscarTiquetes, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 70, 140, 140));

        jButtonBorrarTiquete.setBackground(new java.awt.Color(204, 0, 51));
        jButtonBorrarTiquete.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButtonBorrarTiquete.setForeground(new java.awt.Color(255, 255, 255));
        jButtonBorrarTiquete.setText("BORRAR");
        jButtonBorrarTiquete.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonBorrarTiqueteActionPerformed(evt);
            }
        });
        jPanelFondo.add(jButtonBorrarTiquete, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 240, 140, -1));
    ...
    //Boton borrar tiquete
    private void jButtonBorrarTiqueteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBorrarTiqueteActionPerformed
        
    }//GEN-LAST:event_jButtonBorrarTiqueteActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jButtonBorrarTiquete;
